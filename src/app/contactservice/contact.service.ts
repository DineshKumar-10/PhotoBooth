...
export class ContactService {
  ...
  private apiUrl = 'https://script.google.com/macros/s/AKfycbx6-NH2AUTyBtB8WTAULdFY2xGyXNNjcrPJAkOSh_8j064j93uscG2BZKR0gXN0aZYB/exec';
...
sendData(data: any) {
  ...
  body.set('eventdate',data.eventType);
